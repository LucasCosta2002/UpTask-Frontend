...
export default function DashboardView() {
	...
	//useQuery  obtiene datos
	//useMutation  modifica datos
	//invalidateQueries  modifica el state
								...
								<div className="min-w-0 flex-auto space-y-2">
									<div className="mb-2">
										{ isManager(project.manager, user._id)
											...
											: <p className="font-bold text-xs uppercase bg-indigo-50 text-green-500 border-2 border-green-500 rounded-lg inline-block py-1 px-5">Colaborador/a</p>
										}
									</div>
							...
							<Menu as="div" className="relative flex-none">
								...
								<Transition as={Fragment} enter="transition ease-out duration-100"
									...
									>
										...
										{/*  si es manager puede ver las opciones */}
										{ isManager(project.manager, user._id) && (
											<>
												<MenuItem>
